            ...
            <div class="col-md-10" style="padding-top: 50px;">
                ...
                <form action="core/post_repositorio.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        name="titulo" id="titulo" value="<?php echo $entidade['titulo'] ?? '' ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <input class="form-control" type="date" require="required"
                                id="data_postagem" name="data_postagem" name="data_postagem" value = "<?php echo $data ?>">

                            </div>
                            <div class="col-md-3">
                                <input class="form-control" type="time" require="required"
                                id="hora_postagem" name="hora_postagem" value="<?php echo $hora ?>">
                            </div>
                        </div>
                    </div>
